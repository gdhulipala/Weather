...
public class SettingsActivity extends AppCompatActivity {
    ...
    public static class WeatherPreferenceFragment extends PreferenceFragment implements Preference.OnPreferenceChangeListener {
        ...
        public void onCreate(Bundle savedInstanceState) {
            ...
            Preference  cityName = findPreference(getString(R.string.settings_city_key));
            bindPreferenceSummaryToValue(cityName);

            Preference  stateName = findPreference(getString(R.string.settings_state_key));
            bindPreferenceSummaryToValue(stateName);
