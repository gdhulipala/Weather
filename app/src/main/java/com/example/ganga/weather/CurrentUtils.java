...
/**
 * Created by ganga on 5/22/18.
 */

public class CurrentUtils {

    public static final String LOG_TAG = CurrentUtils.class.getSimpleName();
    ...
    private static List<FiveDays> extractFeatureFromJson(String earthquakeJSON) {
        ...
        try {
            ...
            JSONObject object = baseJsonResponse.getJSONObject(0);
            ...
            int value = imperial.getInt("Value");
            String valueText = String.valueOf(value);

            FiveDays days = new FiveDays(weatherText,valueText);
